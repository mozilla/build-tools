...
var CheckboxEditControlView = EditControlView.extend({
    ...
    controlChanged: function() {
        var sets = {};
        sets[this.column] = this.$(':checkbox').is(':checked')?  1 : 0;
        this.model.set(sets);
        this.model.save();
    },
    ...
    initialize: function(args) {
        ...
        this.formElements = [
            ...
            new CheckboxEditControlView({model: this.model,
                    column: 'disabled', title: 'Disabled' })
        ];
    }
});
...
var SlavesTableView = TableView.extend({
    ...
    columns: [
        ...
        { id: "disabled", renderFn: 'renderDisabled', title: "Disabled" }
    ],
