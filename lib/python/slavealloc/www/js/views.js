...
var TableView = Backbone.View.extend({
    ...
    refresh : function (args) {
        ...
        var newData = self.model.map(function(instance_model) {
            ...
            // data columns
            row = row.concat(
                $.map(self.model.columns, function(col, i) {
...
var TableRowView = Backbone.View.extend({
    ...
    refresh: function() {
        var self = this;
        $.each(this.parentView.model.columns, function (i, col) {
            var id = col.id;
...
var TableEditRowView = Backbone.View.extend({
    ...
    refresh: function() {
        $.each(this.formElements, function(i, elt) { elt.change(); });
    },
});
    ...
    initialize: function(args) {
        ...
        this.addFormElements([
            { column: 'poolid', title: 'Pool',
              change: $.proxy(this, 'poolidChange'),
              render: $.proxy(this, 'poolidRender'), }
        ]);
    },
