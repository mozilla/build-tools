...
// class variable to the appropriate subclass
...
var TableEditRowView = Backbone.View.extend({
    ...
    render: function() {
        ...
        _.each(this.formElements, function(elt) {
            ...
            div.append(elt.render.call(this_));
            el.append(div);
        });
    ...
    refresh: function() {
        var this_ = this;
        _.each(this.formElements, function(elt) { elt.change.call(this_); }); // TODO: call doesn't work
    },
});
