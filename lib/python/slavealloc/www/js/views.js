...
var SlavesTableView = TableView.extend({
    ...
    columns: [
        { id: "name", title: "Name" },
        // TODO: silo only sorts by distro now - change??
        { id: "distro", renderFn: "renderSilo", title: "Silo" },
    ...
    renderSilo: function (model) {
        return (model.get('distro') + '-' +
                model.get('bitlength') + '-' +
                model.get('datacenter') + '-' +
                model.get('trustlevel') + '-' +
