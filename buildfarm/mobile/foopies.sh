...
for f in ${FOOPIES} ; do
  case "$f" in
    ...
    "07" | "7" )
      FOOPY=foopy07
      foopy07="030 031 032 035 036 037 038 039 064 199 200"
      ;;
    "08" | "8" )
      FOOPY=foopy08
      TEGRAS="040 041 042 045 046 047 048 049 050 051 052"
      ;;
    "09" | "9" )
      FOOPY=foopy09
    ...
    "10" )
      FOOPY=foopy10
      TEGRAS="066 067 068 070 071 072 073 074 075 076 077"
      ;;
    "11" )
      FOOPY=foopy11
    ...
    "14" )
      ...
      TEGRAS="118 119 120 121 122 123 148 149 150 151 154 155"
      ;;
    "15" )
      FOOPY=foopy15
      FOOPYIP=10.250.48.217
      TEGRAS="129 130 132 133 134 135 136 138 139 140 141 142 144 145"
      ;;
    "16" )
      FOOPY=foopy16
      FOOPYIP=10.250.48.218
      TEGRAS="158 159 160 161 162 163 164 165 166 167 168 169 170"
      ;;
    "17" )
      FOOPY=foopy17
      FOOPYIP=10.250.48.219
      TEGRAS="173 174 177 179 181 182 183 187 188 189 190 196"
      ;;
    "18" )
      FOOPY=foopy18
    ...
    "23" )
       ...
       TEGRAS="262 263 264 265 266 267 268 269 270 271 272 273 274"
       ;;
    "24" )
       FOOPY=foopy24
