...
for f in ${FOOPIES} ; do
  case "$f" in
    ...
    "07" | "7" )
      FOOPY=foopy07
      foopy07="030 031 032 033 034 035 036 037 038 039"
      ;;
    "08" | "8" )
      FOOPY=foopy08
    ...
    "14" )
      ...
      TEGRAS="118 119 120 121 122 123 148 149 150 151 153 154 155 156 157"
      ;;
    "15" )
      FOOPY=foopy15
    ...
    "17" )
      ...
      TEGRAS="173 174 175 176 177 179 181 182 183 204 205"
      ;;
    * )
      FOOPY=""
      TEGRAS=""
