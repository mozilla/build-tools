...
for f in ${FOOPIES} ; do
  case "$f" in
    ...
    "17" )
      ...
      TEGRAS="173 174 177 179 181 182 183 187 188 189 190 196 198 204 205"
      ;;
    "18" )
      FOOPY=foopy18
    ...
    "19" )
       ...
       TEGRAS="220 221 222 223 224 225 226 227 228 229 287 231 232 233"
       ;;
    "20" )
       FOOPY=foopy20
       FOOPYIP=10.250.48.224
       TEGRAS="234 235 236 237 238 239 240 242 243 244 245 246 247 286"
       ;;
    "21" )
      FOOPY=foopy21
    ...
    "24" )
       ...
       TEGRAS="191 192 276 277 278 279 280 281 282 283 284 285"
       ;;
    * )
      FOOPY=""
      TEGRAS=""
