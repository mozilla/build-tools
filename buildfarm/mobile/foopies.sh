...
for f in ${FOOPIES} ; do
  case "$f" in
    "05" | "5" )
      ...
      # offline 185 -- Bug 741046
    ;;
    "06" | "6" )
      FOOPY=foopy06
      TEGRAS="014 015 016 017 018 019 020 021 022 023 025 026 027 028 029"
      ;;
    "07" | "7" )
      FOOPY=foopy07
      TEGRAS="031 032 035 036 037 038 039 064 078 199 200"
      ;;
    "08" | "8" )
      FOOPY=foopy08
      TEGRAS="040 041 042 045 046 047 048 050 051 052 090"
      ;;
    "09" | "9" )
      FOOPY=foopy09
      TEGRAS="053 054 055 056 057 058 059 060 061 062 063"
      ;;
    "10" )
      FOOPY=foopy10
      TEGRAS="066 067 068 070 071 072 073 074 075 076 091"
      ;;
    "11" )
      FOOPY=foopy11
      TEGRAS="079 080 081 082 083 084 085 086 087 088 089"
      ;;
    "12" )
      FOOPY=foopy12
    ...
    "14" )
      ...
      TEGRAS="118 119 120 121 145 148 149 150 151 152 154 155 157"
      ;;
    "15" )
      FOOPY=foopy15
      FOOPYIP=10.250.48.217
      TEGRAS="129 130 132 133 134 135 136 138 139 140 141 142 144"
      ;;
    "16" )
      FOOPY=foopy16
      FOOPYIP=10.250.48.218
      TEGRAS="158 159 160 162 163 164 165 166 167 168 169 170 171"
      ;;
    "17" )
      FOOPY=foopy17
      FOOPYIP=10.250.48.219
      TEGRAS="173 174 177 178 179 181 182 183 187 188 189 190 196"
      ;;
    "18" )
      FOOPY=foopy18
      FOOPYIP=10.250.48.220
      TEGRAS="206 207 208 209 210 211 212 213 214 215 216 217 218"
      ;;
    "19" )
       FOOPY=foopy19
       FOOPYIP=10.250.48.221
       TEGRAS="146 172 194 220 221 223 225 227 228 229 231 232 233"
       ;;
    "20" )
       FOOPY=foopy20
       FOOPYIP=10.250.48.224
       TEGRAS="234 235 236 237 238 239 240 242 243 244 245 246 247"
       ;;
    "21" )
      FOOPY=foopy21
    ...
    "22" )
       ...
       TEGRAS="248 249 250 251 252 253 254 255 256 257 258 259 260"
       ;;
    "23" )
       FOOPY=foopy23
       FOOPYIP=10.250.48.231
       TEGRAS="195 262 263 264 265 266 267 269 270 271 272 273 274"
       ;;
    "24" )
       FOOPY=foopy24
       FOOPYIP=10.250.48.232
       TEGRAS="191 192 201 276 277 278 279 280 281 282 283 284 285"
       ;;
    * )
      FOOPY=""
      TEGRAS=""
